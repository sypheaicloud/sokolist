...
export async function subscribeUser(formData: FormData) {
    ...
    try {
        ...
        await transporter.sendMail({
            from: `"MarketPlace-Kenya Bot" <${process.env.GMAIL_USER}>`,
            to: process.env.GMAIL_USER,
            replyTo: email,
            // ✅ CORRECT SPELLING HERE
            subject: `[MarketPlace-Kenya Subscriber] ${email}`,
            ...
            html: `
                <div style="font-family: sans-serif; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #f8fafc;">
                    <h2 style="color: #7c3aed; margin-top:0;">New MarketPlace-Kenya Subscriber 🎉</h2>
